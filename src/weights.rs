...
// 20
// --output
// ./runtime/testnet/src/weights/pallet_account_abstraction.rs
// --template
...
pub struct SubstrateWeight<T>(PhantomData<T>);
	...
	/// Storage: `AccountAbstraction::Credentials` (r:0 w:100)
	/// Proof: `AccountAbstraction::Credentials` (`max_values`: None, `max_size`: Some(183), added: 2658, mode: `MaxEncodedLen`)
	...
	/// Storage: `AccountAbstraction::Credentials` (r:1 w:1)
	/// Proof: `AccountAbstraction::Credentials` (`max_values`: None, `max_size`: Some(183), added: 2658, mode: `MaxEncodedLen`)
	fn unregister_credential() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `255`
